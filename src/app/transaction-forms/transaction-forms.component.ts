...
// customerName='';
  customerDetails() {
    console.log(this.everything.customerReferenceNumber)
    this.EmployeeService.getCustomerById(
      ...
      this.mexecutiveService.getByExecutiveCode(data.executiveCode).subscribe(
        (data)=>{
          // this.everything.executiveId=data.id
        }
      )
